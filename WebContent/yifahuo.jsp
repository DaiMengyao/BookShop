		...
		<div class="superCtab">
			...
			<div class="ctab-Main">
				<div class="ctab-Main-title">
					<ul class="clearfix">
						<li><a href="OrderServlet?type=query_unconsign">待发货</a></li>
						<li class="cur">已发货</a></li>
					</ul>
				</div>
				...
				<div class="ctab-Mian-cont">			
					<div class="Mian-cont-wrap">
						...
						%>
								...
								<td class="t_2_1"><%=orders.get(i).getBookid()%></td>
								<td class="t_3"><%=orders.get(i).getPayTime() %></td>
								<td class="t_4"><%=orders.get(i).getUserid() %></td>
								<td class="t_7">
									<div class="btn">
									<a href="OrderServlet?type=details&id=<%=orders.get(i).getOrder_id() %>" >查看详情</a>
									</div>
								</td>
							</tr>
							<%
